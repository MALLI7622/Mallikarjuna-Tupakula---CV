...
\begin{experiences}
    ...
    {March 2026}
                    ...
                    AI Research Intern | Advisor:\textit{\href{https://moonfolk.github.io/}{\textcolor{basecolor}{ Dr. Mikhail Yurochkin }}}
                      \begin{itemize}
                        \item Developed the data \textbf{RL tasks} for STEM post-training from crawled \textbf{arXiv} and \textbf{StackExchange} data for building \textbf{375 MoE} model, while also delivering large-scale supervised fine-tuning datasets which is around 120 billion of tokens.
                        \item Built executable \textbf{Harbor} tasks from \textbf{HLE} and \textbf{SciCode} to evaluate frontier model capabilities on agentic reasoning, tool use, and code execution in containerized environments.
                        \item Generated large-scale synthetic reasoning data using a Socratic student-teacher pipeline, scaling production across \textbf{500 HPC nodes} with validation, filtering, and resumable SLURM workflows.
                        \item Building an \textbf{SFT data agent} that automatically retrieves, interprets, converts, and validates heterogeneous datasets into training-ready SFT format with reasoning-aware quality checks.
                      \end{itemize}
                    }{}
  \emptySeparator
  \experience
    ...
    {September 2024}
                    ...
                    Graduate Research Assistant | Advisor:\textit{\href{https://www.cs.cmu.edu/~akhudabu/}{\textcolor{basecolor}{Prof. Ashique KhudaBhuksh}}}
                      \begin{itemize}
                        \item Solely led \textbf{MoleculeLens}, a novel multimodal interpretable retrieval framework with \textit{\href{https://sites.google.com/site/sanghamitraweb/}{\textcolor{basecolor}{Prof. Sanghamitra Dutta}}}, currently under review; extends prior work on \textbf{Thin Bridges for Drug--Text Alignment} accepted at \textbf{NeurIPS 2025 (FM4LS)}.
    ...
    {December 2020} {
                    Research Assistant | Advisor:\textit{\href{https://sumeetkumar.in/}{\textcolor{basecolor}{Prof. Sumeet Kumar}}
                      ...
                      \begin{itemize}
                        ...
                        \item Understand the user engagement and content dynamics on social media platforms by analyzing the large-scale data, and building machine learning models to predict user behavior and content virality at scale.
                      \end{itemize}
                    }{}
  \emptySeparator
    \experience
